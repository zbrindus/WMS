...
# Aici vine partea grafica a programului.

def message(n):
    messagebox.showinfo(title="Terminare", message=n)
...
dell_button.place(x=20, y=70)

hp_button = Button(master, text="HP", height=2, width=7, command=hp)
hp_button.place(x=20, y=120)

# exista dar inca nu este implementat
# manual_extract_button = Button(master, text='Despartire' + '\n' + ' manuala', height=2, width=7, command=master.quit)
# manual_extract_button.place(x=20, y=207)

extract_button = Button(master, text="Split", height=2, width=8, command=extract)
extract_button.place(x=115, y=70)

rename_button = Button(master, text="Rename", height=2, width=8, command=redenum)
rename_button.place(x=115, y=120)


exit_button = Button(master, text="Exit", height=2, width=8, command=master.quit)
exit_button.place(x=115, y=170)
